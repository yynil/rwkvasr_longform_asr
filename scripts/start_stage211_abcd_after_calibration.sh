...
SUPPLEMENTAL_INVENTORY="${SUPPLEMENTAL_INVENTORY:-${HOME}/rwkvasr_data/stage211_supplemental_combined_v2/supplemental_inventory.json}"
SUPPLEMENTAL_PROFILE_RECEIPT="${SUPPLEMENTAL_PROFILE_RECEIPT:-${HOME}/rwkvasr_data/stage211_supplemental_combined_v2/supplemental_profile_receipt.json}"
