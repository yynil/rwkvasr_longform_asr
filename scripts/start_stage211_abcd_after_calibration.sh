...
LABELED_ROOT="${LABELED_ROOT:-${HOME}/rwkvasr_data/stage211_sft_full_labeled_v3_public_clean}"
LABELED_PROFILE_RECEIPT="${LABELED_PROFILE_RECEIPT:-${LABELED_ROOT}/stage211_labeled_profile_receipt.json}"
SFT_PUBLIC_OVERLAP_RECEIPT="${SFT_PUBLIC_OVERLAP_RECEIPT:-${HOME}/rwkvasr_data/stage211_sft_public_encoded_overlap_v2_clean/receipt.json}"
SFT_OUTPUT_DIR="${SFT_OUTPUT_DIR:-${FULL_OUTPUT_ROOT}/stage211d_labeled_ctc_sft_1ep}"
SFT_CORRECTION_PROFILE_ROOT="${SFT_CORRECTION_PROFILE_ROOT:-${HOME}/rwkvasr_data/stage211_sft_source_balanced_correction_v3_public_clean}"
