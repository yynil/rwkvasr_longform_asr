...
SFT_LABELED_ROOT="${SFT_LABELED_ROOT:-${HOME}/rwkvasr_data/stage211_sft_full_labeled_v3_public_clean}"
...
SUPPLEMENTAL_REPLAY_RECEIPT="${SUPPLEMENTAL_REPLAY_RECEIPT:-${HOME}/rwkvasr_data/stage211_full_curriculum/retention_replay_v4_locality/receipt.json}"
