...
if [[ -z "${CONFIG_YAML}" ]]; then
  case "${MODE}" in
    ...
    emilia_en_zh_joint_rwkv7g1)
      ...
      ;;
    gigaspeech_wenetspeech_joint_rwkv7g1)
      CONFIG_YAML="${REPO_ROOT}/configs/gigaspeech_wenetspeech_joint_rwkv7g1_ctc_ar_4x4090_deepspeed.yaml"
      ;;
    gigaspeech_wenetspeech_joint_rwkv7g1_interleave_from_step28000)
      CONFIG_YAML="${REPO_ROOT}/configs/gigaspeech_wenetspeech_joint_rwkv7g1_ctc_ar_interleave_from_step28000_4x4090_deepspeed.yaml"
      ;;
    *)
